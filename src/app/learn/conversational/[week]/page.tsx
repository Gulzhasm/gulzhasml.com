      ...
      {section.lecturePdfUrl && (
        <div className="mb-10">
          ...
          <a
            ...
            className="flex items-center gap-3 p-5 rounded-xl bg-white border-2 border-[var(--color-accent)] shadow-sm hover:shadow-md transition-all group"
          >
            <div className="w-12 h-12 rounded-lg bg-[var(--color-accent-light)] flex items-center justify-center shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[var(--color-text-muted)] mt-0.5">
                Open or download the lecture slides for this week.
              </p>
            </div>
