...
export const topics: Topic[] = [
    ...
    sections: [
      {
        ...
        resources: [
          { title: "Introduction to Machine Learning", description: "Overview of ML paradigms: supervised vs. unsupervised learning, model types, and the ML workflow from data to prediction.", type: "theory" },
          { title: "Python Fundamentals", description: "Core Python concepts: variables, data types (lists, tuples, dicts, sets), operators, control flow, input/output, and modules.", type: "practice" },
      ...
      },
      {
        ...
        resources: [
          { title: "Probability Foundations", description: "Bayes' rule, prior/posterior/likelihood, Gaussian distribution, random variables, covariance, and Pearson's correlation coefficient.", type: "theory" },
          { title: "Probability Exercises", description: "Implementing Bayes' rule for real scenarios, plotting Gaussian PDFs, computing covariance and PCC, analyzing Iris dataset joint/conditional/marginal probabilities.", type: "practice" },
        ],
      },
      {
        week: 3,
        ...
        resources: [
          { title: "Linear Regression Theory", description: "Hypothesis function, MSE cost, gradient descent derivation, feature normalization, overfitting/underfitting, and L2 regularization.", type: "theory" },
          { title: "Regression Implementation (PyTorch)", description: "Building linear regression from scratch: custom nn.Module layer, MSE implementation, gradient descent, Diabetes dataset prediction, learning rate analysis.", type: "practice" },
      ...
      },
      {
        ...
        resources: [
          { title: "Classification & Logistic Regression", description: "Sigmoid function, decision boundaries, binary cross-entropy loss, gradient descent for classification, and multi-class one-vs-all strategy.", type: "theory" },
          { title: "Classification Implementation (PyTorch)", description: "Implementing sigmoid, LogisticRegression class, BCE loss, decision boundary visualization on Iris dataset, multi-class 1-vs-all with softmax.", type: "practice" },
      ...
      },
      {
        ...
        resources: [
          { title: "Trees & Bayesian Classification", description: "Multinomial logistic regression, decision trees (entropy, information gain), Gaussian Naive Bayes, and probabilistic classification.", type: "theory" },
          { title: "Advanced Classification Practice", description: "Comparing LogisticRegression, DecisionTreeClassifier, and GaussianNB on Forest Covertype. Confusion matrices, class imbalance handling with SMOTE.", type: "practice" },
        ],
      },
      {
        week: 6,
        ...
        resources: [
          { title: "Neural Networks Fundamentals", description: "MLP architecture, activation functions, universal approximation theorem, backpropagation algorithm, and weight initialization.", type: "theory" },
          { title: "Neural Networks Implementation (PyTorch)", description: "Solving XOR with a 2-layer MLP, building configurable neural networks for Iris classification, training loops with validation.", type: "practice" },
      ...
      },
      {
        ...
        resources: [
          { title: "Clustering Algorithms", description: "K-means algorithm, convergence properties, initialization strategies, elbow method, hierarchical/agglomerative clustering, and dendrograms.", type: "theory" },
          { title: "Clustering Practice", description: "K-means on Iris dataset, elbow curve analysis, hierarchical clustering with dendrograms, customer segmentation on iFood marketing data.", type: "practice" },
        ],
      },
      {
        week: 8,
        ...
        resources: [
          { title: "Density Estimation & EM Algorithm", description: "Mixture of Gaussians model, EM algorithm (E-step, M-step), log-likelihood convergence, and Bayesian classification from density models.", type: "theory" },
          { title: "Density Estimation Practice", description: "Implementing MoG with EM for vowel phoneme data, building classifiers from density estimates, exploring K values and singularity handling.", type: "practice" },
      ...
      },
      {
        ...
        resources: [
          { title: "PCA & Feature Selection", description: "Dimensionality reduction motivation, PCA derivation (covariance, eigenvalues, projection), explained variance, and feature selection methods.", type: "theory" },
          { title: "Dimensionality Reduction Practice", description: "PCA from scratch with eigenvectors, explained variance analysis, 2D visualization of high-dimensional data, feature selection on Diabetes dataset.", type: "practice" },
        ],
      },
      {
        week: 10,
        ...
        resources: [
          { title: "Deep Learning & CNNs", description: "Convolutional neural networks, pooling, ResNet architecture, transfer learning, fine-tuning, and autoencoders for unsupervised learning.", type: "theory" },
          { title: "Deep Learning Practice (CIFAR-10)", description: "Training ResNet18 from scratch vs. transfer learning on CIFAR-10, fine-tuning pretrained models, and building autoencoders.", type: "practice" },
        ],
      },
    ],
    tags: [
  ...
  // --- Advanced Topics ---
  {
    ...
    resources: [
      { title: "Neural Network Basics", description: "Feed-forward networks, backpropagation", type: "practice" },
      { title: "Word Embeddings", description: "Word2Vec, GloVe implementations", type: "practice" },
      { title: "RNNs and LSTMs", description: "Sequence modeling for text", type: "practice" },
      { title: "Attention & Transformers", description: "Self-attention, multi-head attention", type: "practice" },
    ],
  ...
  },
  {
    ...
    resources: [
      { title: "Dialogue Act Tagging", description: "Classifying utterance types in conversation", type: "practice" },
      { title: "Seq2Seq for Dialogue", description: "Encoder-decoder models for response generation", type: "theory" },
    ],
  ...
  },
  {
    ...
    resources: [
      { title: "Boolean & VSM Retrieval", description: "Boolean queries, TF-IDF, vector space model", type: "theory" },
      { title: "BM25 & Language Models", description: "Probabilistic retrieval and language modeling", type: "theory" },
      { title: "Search Engine Project", description: "Building a search engine from scratch", type: "project" },
    ],
