...
export const practiceQuestions: ExamQuestion[] = [
  ...
  },
  {
    id: 3,
    set: 1,
    question: `A Mobile Network Operator is building an analytics platform to analyze and optimize a company's operations using Amazon Athena and Amazon S3.The source systems send data in .CSV format in real time. The Data Engineering team wants to transform the data to the Apache Parquet format before storing it on Amazon S3.Which solution takes the LEAST effort to implement? [{"voted_answers": "D", "vote_count": 25, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 20, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 5,
    set: 1,
    question: `A Data Engineer needs to build a model using a dataset containing customer credit card informationHow can the Data Engineer ensure the data remains encrypted and the credit card information is secure? [{"voted_answers": "D", "vote_count": 16, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 6,
    set: 1,
    question: `A Machine Learning Specialist is using an Amazon SageMaker notebook instance in a private subnet of a corporate VPC. The ML Specialist has important data stored on the Amazon SageMaker notebook instance's Amazon EBS volume, and needs to take a snapshot of that EBS volume. However, the ML Specialist cannot find the Amazon SageMaker notebook instance's EBS volume or Amazon EC2 instance within the VPC.Why is the ML Specialist not seeing the instance visible in the VPC? [{"voted_answers": "C", "vote_count": 24, "is_most_voted": true}, {"voted_answers": "A", "vote_count": 7, "is_most_voted": false}, {"voted_answers": "B", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 8,
    set: 1,
    question: `A manufacturing company has structured and unstructured data stored in an Amazon S3 bucket. A Machine Learning Specialist wants to use SQL to run queries on this data.Which solution requires the LEAST effort to be able to query this data? [{"voted_answers": "B", "vote_count": 15, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 10,
    set: 1,
    question: `A Machine Learning Specialist has completed a proof of concept for a company using a small data sample, and now the Specialist is ready to implement an end- to-end solution in AWS using Amazon SageMaker. The historical training data is stored in Amazon RDS.Which approach should the Specialist use for training a model using that data? [{"voted_answers": "B", "vote_count": 12, "is_most_voted": true}, {"voted_answers": "A", "vote_count": 5, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 13,
    set: 2,
    question: `The displayed graph is from a forecasting model for testing a time series.Considering the graph only, which conclusion should a Machine Learning Specialist make about the behavior of the model? [{"voted_answers": "A", "vote_count": 3, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 16,
    set: 2,
    question: `During mini-batch training of a neural network for a classification problem, a Data Scientist notices that training accuracy oscillates.What is the MOST likely cause of this issue? [{"voted_answers": "D", "vote_count": 11, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 17,
    set: 2,
    question: `An employee found a video clip with audio on a company's social media feed. The language used in the video is Spanish. English is the employee's first language, and they do not understand Spanish. The employee wants to do a sentiment analysis.What combination of services is the MOST efficient to accomplish the task? [{"voted_answers": "A", "vote_count": 10, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 30,
    set: 3,
    question: `When submitting Amazon SageMaker training jobs using one of the built-in algorithms, which common parameters MUST be specified? (Choose three.) [{"voted_answers": "ACF", "vote_count": 17, "is_most_voted": true}, {"voted_answers": "CEF", "vote_count": 14, "is_most_voted": false}, {"voted_answers": "AEF", "vote_count": 3, "is_most_voted": false}, {"voted_answers": "ACD", "vote_count": 2, "is_most_voted": false}, {"voted_answers": "ADE", "vote_count": 1, "is_most_voted": false}, {"voted_answers": "ADF", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 32,
    set: 4,
    question: `Machine Learning Specialist is working with a media company to perform classification on popular articles from the company's website. The company is using random forests to classify how popular an article will be before it is published. A sample of the data being used is below.Given the dataset, the Specialist wants to convert the Day_Of_Week column to binary values.What technique should be used to convert this column to binary values? [{"voted_answers": "B", "vote_count": 3, "is_most_voted": true}]`,
    choices: [
      `Binarization`,
      `One-hot encoding`,
      `Tokenization`,
  ...
  },
  {
    id: 39,
    set: 4,
    question: `A Machine Learning Specialist built an image classification deep learning model. However, the Specialist ran into an overfitting problem in which the training and testing accuracies were 99% and 75%, respectively.How should the Specialist address this issue and what is the reason behind it? [{"voted_answers": "B", "vote_count": 19, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 42,
    set: 5,
    question: `A Machine Learning Specialist is implementing a full Bayesian network on a dataset that describes public transit in New York City. One of the random variables is discrete, and represents the number of minutes New Yorkers wait for a bus given that the buses cycle every 10 minutes, with a mean of 3 minutes.Which prior probability distribution should the ML Specialist use for this variable? [{"voted_answers": "A", "vote_count": 18, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 3, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 44,
    set: 5,
    question: `A Machine Learning Specialist has created a deep learning neural network model that performs well on the training data but performs poorly on the test data.Which of the following methods should the Specialist consider using to correct this? (Choose three.) [{"voted_answers": "BCF", "vote_count": 14, "is_most_voted": true}, {"voted_answers": "BCE", "vote_count": 3, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 47,
    set: 5,
    question: `A company is setting up an Amazon SageMaker environment. The corporate data security policy does not allow communication over the internet.How can the company enable the Amazon SageMaker service without enabling direct internet access to Amazon SageMaker notebook instances? [{"voted_answers": "C", "vote_count": 16, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 49,
    set: 5,
    question: `An office security agency conducted a successful pilot using 100 cameras installed at key locations within the main office. Images from the cameras were uploaded to Amazon S3 and tagged using Amazon Rekognition, and the results were stored in Amazon ES. The agency is now looking to expand the pilot into a full production system using thousands of video cameras in its office locations globally. The goal is to identify activities performed by non-employees in real timeWhich solution should the agency consider? [{"voted_answers": "A", "vote_count": 10, "is_most_voted": true}, {"voted_answers": "C", "vote_count": 2, "is_most_voted": false}, {"voted_answers": "D", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 50,
    set: 5,
    question: `A Marketing Manager at a pet insurance company plans to launch a targeted marketing campaign on social media to acquire new customers. Currently, the company has the following data in Amazon Aurora:✑ Profiles for all past and existing customers✑ Profiles for all past and existing insured pets✑ Policy-level information✑ Premiums received✑ Claims paidWhat steps should be taken to implement a machine learning model to identify potential new customers on social media? [{"voted_answers": "B", "vote_count": 18, "is_most_voted": true}, {"voted_answers": "C", "vote_count": 7, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 51,
    set: 6,
    question: `A manufacturing company has a large set of labeled historical sales data. The manufacturer would like to predict how many units of a particular part should be produced each quarter.Which machine learning approach should be used to solve this problem? [{"voted_answers": "D", "vote_count": 19, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 2, "is_most_voted": false}]`,
    choices: [
      `Logistic regression`,
  ...
  },
  {
    id: 54,
    set: 6,
    question: `Which of the following metrics should a Machine Learning Specialist generally use to compare/evaluate machine learning classification models against each other? [{"voted_answers": "D", "vote_count": 7, "is_most_voted": true}]`,
    choices: [
      `Recall`,
      `Misclassification rate`,
  ...
  },
  {
    id: 55,
    set: 6,
    question: `A company is running a machine learning prediction service that generates 100 TB of predictions every day. A Machine Learning Specialist must generate a visualization of the daily precision-recall curve from the predictions, and forward a read-only version to the Business team.Which solution requires the LEAST coding effort? [{"voted_answers": "C", "vote_count": 15, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 10, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 58,
    set: 6,
    question: `A Machine Learning Specialist needs to be able to ingest streaming data and store it in Apache Parquet files for exploration and analysis.Which of the following services would both ingest and store this data in the correct format? [{"voted_answers": "C", "vote_count": 3, "is_most_voted": true}]`,
    choices: [
      `AWS DMS`,
  ...
  },
  {
    id: 60,
    set: 6,
    question: `A Machine Learning Specialist is assigned a TensorFlow project using Amazon SageMaker for training, and needs to continue working for an extended period with no Wi-Fi access.Which approach should the Specialist use to continue working? [{"voted_answers": "B", "vote_count": 6, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 6, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 62,
    set: 7,
    question: `A Data Scientist wants to gain real-time insights into a data stream of GZIP files.Which solution would allow the use of SQL to query the stream with the LEAST latency? [{"voted_answers": "A", "vote_count": 11, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 4, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 64,
    set: 7,
    question: `A Data Scientist is working on an application that performs sentiment analysis. The validation accuracy is poor, and the Data Scientist thinks that the cause may be a rich vocabulary and a low average frequency of words in the dataset.Which tool should be used to improve the validation accuracy? [{"voted_answers": "D", "vote_count": 22, "is_most_voted": true}, {"voted_answers": "C", "vote_count": 10, "is_most_voted": false}, {"voted_answers": "A", "vote_count": 3, "is_most_voted": false}, {"voted_answers": "B", "vote_count": 2, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 68,
    set: 7,
    question: `An agency collects census information within a country to determine healthcare and social program needs by province and city. The census form collects responses for approximately 500 questions from each citizen.Which combination of algorithms would provide the appropriate insights? (Choose two.) [{"voted_answers": "CD", "vote_count": 9, "is_most_voted": true}, {"voted_answers": "BD", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 70,
    set: 7,
    question: `A Machine Learning Specialist uploads a dataset to an Amazon S3 bucket protected with server-side encryption using AWS KMS.How should the ML Specialist define the Amazon SageMaker notebook instance so it can read the same dataset from Amazon S3? [{"voted_answers": "C", "vote_count": 13, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 75,
    set: 8,
    question: `A Machine Learning Specialist wants to determine the appropriate SageMakerVariantInvocationsPerInstance setting for an endpoint automatic scaling configuration. The Specialist has performed a load test on a single instance and determined that peak requests per second (RPS) without service degradation is about 20 RPS. As this is the first deployment, the Specialist intends to set the invocation safety factor to 0.5.Based on the stated parameters and given that the invocations per instance setting is measured on a per-minute basis, what should the Specialist set as theSageMakerVariantInvocationsPerInstance setting? [{"voted_answers": "C", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
      `10`,
      `30`,
      `600`,
  ...
  },
  {
    id: 76,
    set: 8,
    question: `A company uses a long short-term memory (LSTM) model to evaluate the risk factors of a particular energy sector. The model reviews multi-page text documents to analyze each sentence of the text and categorize it as either a potential risk or no risk. The model is not performing well, even though the Data Scientist has experimented with many different network structures and tuned the corresponding hyperparameters.Which approach will provide the MAXIMUM performance boost? [{"voted_answers": "D", "vote_count": 15, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 78,
    set: 8,
    question: `A Machine Learning Specialist previously trained a logistic regression model using scikit-learn on a local machine, and the Specialist now wants to deploy it to production for inference only.What steps should be taken to ensure Amazon SageMaker can host a model that was trained locally? [{"voted_answers": "A", "vote_count": 16, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 81,
    set: 9,
    question: `A Data Scientist is training a multilayer perception (MLP) on a dataset with multiple classes. The target class of interest is unique compared to the other classes within the dataset, but it does not achieve and acceptable recall metric. The Data Scientist has already tried varying the number and size of the MLP's hidden layers, which has not significantly improved the results. A solution to improve recall must be implemented as quickly as possible.Which techniques should be used to meet these requirements? [{"voted_answers": "D", "vote_count": 14, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 83,
    set: 9,
    question: `A real estate company wants to create a machine learning model for predicting housing prices based on a historical dataset. The dataset contains 32 features.Which model will meet the business requirement? [{"voted_answers": "B", "vote_count": 4, "is_most_voted": true}]`,
    choices: [
      `Logistic regression`,
      `Linear regression`,
      `K-means`,
  ...
  },
  {
    id: 84,
    set: 9,
    question: `A Machine Learning Specialist is applying a linear least squares regression model to a dataset with 1,000 records and 50 features. Prior to training, the MLSpecialist notices that two features are perfectly linearly dependent.Why could this be an issue for the linear least squares regression model? [{"voted_answers": "B", "vote_count": 12, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 3, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 85,
    set: 9,
    question: `Given the following confusion matrix for a movie classification model, what is the true class frequency for Romance and the predicted class frequency forAdventure? [{"voted_answers": "B", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 86,
    set: 9,
    question: `A Machine Learning Specialist wants to bring a custom algorithm to Amazon SageMaker. The Specialist implements the algorithm in a Docker container supported by Amazon SageMaker.How should the Specialist package the Docker container so that Amazon SageMaker can launch the training correctly? [{"voted_answers": "C", "vote_count": 10, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 1, "is_most_voted": false}, {"voted_answers": "B", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 90,
    set: 9,
    question: `A Machine Learning Specialist is planning to create a long-running Amazon EMR cluster. The EMR cluster will have 1 master node, 10 core nodes, and 20 task nodes. To save on costs, the Specialist will use Spot Instances in the EMR cluster.Which nodes should the Specialist launch on Spot Instances? [{"voted_answers": "C", "vote_count": 10, "is_most_voted": true}]`,
    choices: [
      `Master node`,
  ...
  },
  {
    id: 95,
    set: 10,
    question: `This graph shows the training and validation loss against the epochs for a neural network.The network being trained is as follows:✑ Two dense layers, one output neuron✑ 100 neurons in each layer✑ 100 epochsRandom initialization of weightsWhich technique can be used to improve model performance in terms of accuracy in the validation set? [{"voted_answers": "A", "vote_count": 5, "is_most_voted": true}]`,
    choices: [
      `Early stopping`,
  ...
  },
  {
    id: 96,
    set: 10,
    question: `A Machine Learning Specialist is attempting to build a linear regression model.Given the displayed residual plot only, what is the MOST likely problem with the model? [{"voted_answers": "A", "vote_count": 6, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 2, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 102,
    set: 11,
    question: `A Machine Learning Specialist prepared the following graph displaying the results of k-means for k = [1..10]:Considering the graph, what is a reasonable selection for the optimal choice of k? [{"voted_answers": "B", "vote_count": 11, "is_most_voted": true}]`,
    choices: [
      `1`,
      `4`,
      `7`,
  ...
  },
  {
    id: 113,
    set: 12,
    question: `A Machine Learning Specialist is designing a scalable data storage solution for Amazon SageMaker. There is an existing TensorFlow-based model implemented as a train.py script that relies on static training data that is currently stored as TFRecords.Which method of providing training data to Amazon SageMaker would meet the business requirements with the LEAST development overhead? [{"voted_answers": "B", "vote_count": 9, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 124,
    set: 13,
    question: `A data scientist has developed a machine learning translation model for English to Japanese by using Amazon SageMaker's built-in seq2seq algorithm with500,000 aligned sentence pairs. While testing with sample sentences, the data scientist finds that the translation quality is reasonable for an example as short as five words. However, the quality becomes unacceptable if the sentence is 100 words long.Which action will resolve the problem? [{"voted_answers": "C", "vote_count": 11, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 158,
    set: 16,
    question: `A company that manufactures mobile devices wants to determine and calibrate the appropriate sales price for its devices. The company is collecting the relevant data and is determining data features that it can use to train machine learning (ML) models. There are more than 1,000 features, and the company wants to determine the primary features that contribute to the sales price.Which techniques should the company use for feature selection? (Choose three.) [{"voted_answers": "BDE", "vote_count": 35, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 162,
    set: 17,
    question: `A machine learning specialist is developing a regression model to predict rental rates from rental listings. A variable named Wall_Color represents the most prominent exterior wall color of the property. The following is the sample data, excluding all other variables:The specialist chose a model that needs numerical input data.Which feature engineering approaches should the specialist use to allow the regression model to learn from the Wall_Color data? (Choose two.) [{"voted_answers": "BE", "vote_count": 15, "is_most_voted": true}, {"voted_answers": "BD", "vote_count": 8, "is_most_voted": false}, {"voted_answers": "AB", "vote_count": 2, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 201,
    set: 21,
    question: `A company's machine learning (ML) specialist is designing a scalable data storage solution for Amazon SageMaker. The company has an existing TensorFlow-based model that uses a train.py script. The model relies on static training data that is currently stored in TFRecord format.What should the ML specialist do to provide the training data to SageMaker with the LEAST development overhead? [{"voted_answers": "D", "vote_count": 19, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 210,
    set: 22,
    question: `A bank wants to use a machine learning (ML) model to predict if users will default on credit card payments. The training data consists of 30,000 labeled records and is evenly balanced between two categories. For the model, an ML specialist selects the Amazon SageMaker built-in XGBoost algorithm and configures a SageMaker automatic hyperparameter optimization job with the Bayesian method. The ML specialist uses the validation accuracy as the objective metric.When the bank implements the solution with this model, the prediction accuracy is 75%. The bank has given the ML specialist 1 day to improve the model in production.Which approach is the FASTEST way to improve the model's accuracy? [{"voted_answers": "C", "vote_count": 11, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 4, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 211,
    set: 22,
    question: `A data scientist has 20 TB of data in CSV format in an Amazon S3 bucket. The data scientist needs to convert the data to Apache Parquet format.How can the data scientist convert the file format with the LEAST amount of effort? [{"voted_answers": "B", "vote_count": 7, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 238,
    set: 24,
    question: `An engraving company wants to automate its quality control process for plaques. The company performs the process before mailing each customized plaque to a customer. The company has created an Amazon S3 bucket that contains images of defects that should cause a plaque to be rejected. Low-confidence predictions must be sent to an internal team of reviewers who are using Amazon Augmented AI (Amazon A2I).Which solution will meet these requirements? [{"voted_answers": "B", "vote_count": 10, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 251,
    set: 26,
    question: `A manufacturing company wants to create a machine learning (ML) model to predict when equipment is likely to fail. A data science team already constructed a deep learning model by using TensorFlow and a custom Python script in a local environment. The company wants to use Amazon SageMaker to train the model.Which TensorFlow estimator configuration will train the model MOST cost-effectively? [{"voted_answers": "B", "vote_count": 12, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 254,
    set: 26,
    question: `A car company is developing a machine learning solution to detect whether a car is present in an image. The image dataset consists of one million images. Each image in the dataset is 200 pixels in height by 200 pixels in width. Each image is labeled as either having a car or not having a car.Which architecture is MOST likely to produce a model that detects whether a car is present in an image with the highest accuracy? [{"voted_answers": "B", "vote_count": 9, "is_most_voted": true}, {"voted_answers": "A", "vote_count": 4, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 257,
    set: 26,
    question: `A beauty supply store wants to understand some characteristics of visitors to the store. The store has security video recordings from the past several years. The store wants to generate a report of hourly visitors from the recordings. The report should group visitors by hair style and hair color.Which solution will meet these requirements with the LEAST amount of effort? [{"voted_answers": "A", "vote_count": 10, "is_most_voted": true}, {"voted_answers": "C", "vote_count": 9, "is_most_voted": false}, {"voted_answers": "D", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 258,
    set: 26,
    question: `A financial services company wants to automate its loan approval process by building a machine learning (ML) model. Each loan data point contains credit history from a third-party data source and demographic information about the customer. Each loan approval prediction must come with a report that contains an explanation for why the customer was approved for a loan or was denied for a loan. The company will use Amazon SageMaker to build the model.Which solution will meet these requirements with the LEAST development effort? [{"voted_answers": "C", "vote_count": 5, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 263,
    set: 27,
    question: `A company needs to deploy a chatbot to answer common questions from customers. The chatbot must base its answers on company documentation.Which solution will meet these requirements with the LEAST development effort? [{"voted_answers": "A", "vote_count": 10, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 266,
    set: 27,
    question: `A company is deploying a new machine learning (ML) model in a production environment. The company is concerned that the ML model will drift over time, so the company creates a script to aggregate all inputs and predictions into a single file at the end of each day. The company stores the file as an object in an Amazon S3 bucket. The total size of the daily file is 100 GB. The daily file size will increase over time.Four times a year, the company samples the data from the previous 90 days to check the ML model for drift. After the 90-day period, the company must keep the files for compliance reasons.The company needs to use S3 storage classes to minimize costs. The company wants to maintain the same storage durability of the data.Which solution will meet these requirements? [{"voted_answers": "C", "vote_count": 15, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 13, "is_most_voted": false}, {"voted_answers": "A", "vote_count": 3, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 274,
    set: 28,
    question: `A machine learning (ML) engineer has created a feature repository in Amazon SageMaker Feature Store for the company. The company has AWS accounts for development, integration, and production. The company hosts a feature store in the development account. The company uses Amazon S3 buckets to store feature values offline. The company wants to share features and to allow the integration account and the production account to reuse the features that are in the feature repository.Which combination of steps will meet these requirements? (Choose two.) [{"voted_answers": "AB", "vote_count": 7, "is_most_voted": true}, {"voted_answers": "AC", "vote_count": 5, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 280,
    set: 29,
    question: `A data scientist is using Amazon Comprehend to perform sentiment analysis on a dataset of one million social media posts.Which approach will process the dataset in the LEAST time? [{"voted_answers": "C", "vote_count": 11, "is_most_voted": true}, {"voted_answers": "B", "vote_count": 7, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 290,
    set: 30,
    question: `A company wants to create an artificial intelligence (AШ) yoga instructor that can lead large classes of students. The company needs to create a feature that can accurately count the number of students who are in a class. The company also needs a feature that can differentiate students who are performing a yoga stretch correctly from students who are performing a stretch incorrectly.Determine whether students are performing a stretch correctly, the solution needs to measure the location and angle of each student’s arms and legs. A data scientist must use Amazon SageMaker to access video footage of a yoga class by extracting image frames and applying computer vision models.Which combination of models will meet these requirements with the LEAST effort? (Choose two.) [{"voted_answers": "CD", "vote_count": 7, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 298,
    set: 30,
    question: `A company deployed a machine learning (ML) model on the company website to predict real estate prices. Several months after deployment, an ML engineer notices that the accuracy of the model has gradually decreased.The ML engineer needs to improve the accuracy of the model. The engineer also needs to receive notifications for any future performance issues.Which solution will meet these requirements? [{"voted_answers": "A", "vote_count": 6, "is_most_voted": true}, {"voted_answers": "D", "vote_count": 2, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 303,
    set: 31,
    question: `A company builds computer-vision models that use deep learning for the autonomous vehicle industry. A machine learning (ML) specialist uses an Amazon EC2 instance that has a CPU:GPU ratio of 12:1 to train the models.The ML specialist examines the instance metric logs and notices that the GPU is idle half of the time. The ML specialist must reduce training costs without increasing the duration of the training jobs.Which solution will meet these requirements? [{"voted_answers": "B", "vote_count": 3, "is_most_voted": false}, {"voted_answers": "D", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 325,
    set: 33,
    question: `A data scientist is designing a repository that will contain many images of vehicles. The repository must scale automatically in size to store new images every day. The repository must support versioning of the images. The data scientist must implement a solution that maintains multiple immediately accessible copies of the data in different AWS Regions.Which solution will meet these requirements? [{"voted_answers": "A", "vote_count": 5, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 336,
    set: 34,
    question: `A machine learning (ML) engineer is using Amazon SageMaker automatic model tuning (AMT) to optimize a model's hyperparameters. The ML engineer notices that the tuning jobs take a long time to run. The tuning jobs continue even when the jobs are not significantly improving against the objective metric.The ML engineer needs the training jobs to optimize the hyperparameters more quickly.How should the ML engineer configure the SageMaker AMT data types to meet these requirements? [{"voted_answers": "D", "vote_count": 5, "is_most_voted": true}, {"voted_answers": "A", "vote_count": 1, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 344,
    set: 35,
    question: `An ecommerce company discovers that the search tool for the company's website is not presenting the top search results to customers. The company needs to resolve the issue so the search tool will present results that customers are most likely to want to purchase.Which solution will meet this requirement with the LEAST operational effort? [{"voted_answers": "C", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
  ...
  },
  {
    id: 349,
    set: 35,
    question: `A company’s machine learning (ML) team needs to build a system that can detect whether people in a collection of images are wearing the company’s logo. The company has a set of labeled training data.Which algorithm should the ML team use to meet this requirement? [{"voted_answers": "D", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
      `Principal component analysis (PCA)`,
      `Recurrent neural network (RNN)`,
  ...
  },
  {
    id: 357,
    set: 36,
    question: `An ecommerce company has observed that customers who use the company's website rarely view items that the website recommends to customers. The company wants to recommend items to customers that customers are more likely to want to purchase.Which solution will meet this requirement in the SHORTEST amount of time? [{"voted_answers": "C", "vote_count": 3, "is_most_voted": false}]`,
    choices: [
  ...
  },
  {
    id: 359,
    set: 36,
    question: `A manufacturing company produces 100 types of steel rods. The rod types have varying material grades and dimensions. The company has sales data for the steel rods for the past 50 years.A data scientist needs to build a machine learning (ML) model to predict future sales of the steel rods.Which solution will meet this requirement in the MOST operationally efficient way? [{"voted_answers": "A", "vote_count": 2, "is_most_voted": true}]`,
    choices: [
...
export const practiceSets: PracticeSet[] = [
  {
    ...
    description: "Questions 1–10 (10 questions)",
    questionCount: 10,
  },
  {
    id: 2,
    title: "Practice Set 2",
    description: "Questions 11–20 (10 questions)",
    questionCount: 10,
  },
  {
    id: 3,
    title: "Practice Set 3",
    description: "Questions 21–30 (10 questions)",
    questionCount: 10,
  },
  {
    id: 4,
    title: "Practice Set 4",
    description: "Questions 31–40 (10 questions)",
    questionCount: 10,
  },
  {
    id: 5,
    title: "Practice Set 5",
    description: "Questions 41–50 (10 questions)",
    questionCount: 10,
  },
  {
    id: 6,
    title: "Practice Set 6",
    description: "Questions 51–60 (10 questions)",
    questionCount: 10,
  },
  {
    id: 7,
    title: "Practice Set 7",
    description: "Questions 61–70 (10 questions)",
    questionCount: 10,
  },
  {
    id: 8,
    title: "Practice Set 8",
    description: "Questions 71–80 (10 questions)",
    questionCount: 10,
  },
  {
    id: 9,
    title: "Practice Set 9",
    description: "Questions 81–90 (10 questions)",
    questionCount: 10,
  },
  {
    id: 10,
    title: "Practice Set 10",
    description: "Questions 91–100 (10 questions)",
    questionCount: 10,
  },
  {
    id: 11,
    title: "Practice Set 11",
    description: "Questions 101–110 (10 questions)",
    questionCount: 10,
  },
  {
    id: 12,
    title: "Practice Set 12",
    description: "Questions 111–120 (10 questions)",
    questionCount: 10,
  },
  {
    id: 13,
    title: "Practice Set 13",
    description: "Questions 121–130 (10 questions)",
    questionCount: 10,
  },
  {
    id: 14,
    title: "Practice Set 14",
    description: "Questions 131–140 (9 questions)",
    questionCount: 9,
  },
  {
    id: 15,
    title: "Practice Set 15",
    description: "Questions 141–150 (10 questions)",
    questionCount: 10,
  },
  {
    id: 16,
    title: "Practice Set 16",
    description: "Questions 151–160 (10 questions)",
    questionCount: 10,
  },
  {
    id: 17,
    title: "Practice Set 17",
    description: "Questions 161–170 (10 questions)",
    questionCount: 10,
  },
  {
    id: 18,
    title: "Practice Set 18",
    description: "Questions 171–180 (10 questions)",
    questionCount: 10,
  },
  {
    id: 19,
    title: "Practice Set 19",
    description: "Questions 181–190 (10 questions)",
    questionCount: 10,
  },
  {
    id: 20,
    title: "Practice Set 20",
    description: "Questions 191–200 (10 questions)",
    questionCount: 10,
  },
  {
    id: 21,
    title: "Practice Set 21",
    description: "Questions 201–210 (10 questions)",
    questionCount: 10,
  },
  {
    id: 22,
    title: "Practice Set 22",
    description: "Questions 211–220 (10 questions)",
    questionCount: 10,
  },
  {
    id: 23,
    title: "Practice Set 23",
    description: "Questions 221–230 (10 questions)",
    questionCount: 10,
  },
  {
    id: 24,
    title: "Practice Set 24",
    description: "Questions 231–240 (10 questions)",
    questionCount: 10,
  },
  {
    id: 25,
    title: "Practice Set 25",
    description: "Questions 241–250 (10 questions)",
    questionCount: 10,
  },
  {
    id: 26,
    title: "Practice Set 26",
    description: "Questions 251–260 (10 questions)",
    questionCount: 10,
  },
  {
    id: 27,
    title: "Practice Set 27",
    description: "Questions 261–270 (10 questions)",
    questionCount: 10,
  },
  {
    id: 28,
    title: "Practice Set 28",
    description: "Questions 271–280 (10 questions)",
    questionCount: 10,
  },
  {
    id: 29,
    title: "Practice Set 29",
    description: "Questions 281–290 (10 questions)",
    questionCount: 10,
  },
  {
    id: 30,
    title: "Practice Set 30",
    description: "Questions 291–300 (10 questions)",
    questionCount: 10,
  },
  {
    id: 31,
    title: "Practice Set 31",
    description: "Questions 301–310 (10 questions)",
    questionCount: 10,
  },
  {
    id: 32,
    title: "Practice Set 32",
    description: "Questions 311–320 (10 questions)",
    questionCount: 10,
  },
  {
    id: 33,
    title: "Practice Set 33",
    description: "Questions 321–330 (10 questions)",
    questionCount: 10,
  },
  {
    id: 34,
    title: "Practice Set 34",
    description: "Questions 331–340 (10 questions)",
    questionCount: 10,
  },
  {
    id: 35,
    title: "Practice Set 35",
    description: "Questions 341–350 (10 questions)",
    questionCount: 10,
  },
  {
    id: 36,
    title: "Practice Set 36",
    description: "Questions 351–360 (10 questions)",
    questionCount: 10,
  },
  {
    id: 37,
    title: "Practice Set 37",
    description: "Questions 361–369 (9 questions)",
    questionCount: 9,
  },
];

export function getQuestionsForSet(setId: number): ExamQuestion[] {
  return practiceQuestions.filter((q) => q.set === setId);
}
